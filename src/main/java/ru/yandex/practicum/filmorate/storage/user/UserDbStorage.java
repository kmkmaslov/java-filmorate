...
public class UserDbStorage implements UserStorage {
    ...
    public User create(User user) {
        ...
        jdbcTemplate.update(new PreparedStatementCreator() {
            @Override
            public @NotNull PreparedStatement createPreparedStatement(@NotNull Connection connection) throws SQLException {
    ...
    private void createFriendships(int userId, Map<Integer, Boolean> friends) {
        String sqlFriends = "insert into friendships (user_id, friend_id, status) values (?, ?, ?)";
    ...
    public User update(User user) {
        ...
        int totalUpdate = jdbcTemplate.update(sqlQuery, user.getEmail(), user.getLogin(), user.getName(), user.getBirthday(), userId);
        if (totalUpdate == 0) {
